...
OutputDir=C:\Users\melio\Documents\GitHub\peak\output
...
[Files]
Source: "C:\Users\melio\Documents\GitHub\peak\dist\installer_updater.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\peak\peak.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\melio\Documents\GitHub\peak\peak.png"; DestDir: "{app}"; Flags: ignoreversion
...
begin
  ...
  RunUninstaller(ExpandConstant('{userappdata}\StormGamesStudios\NewGameDir\PEAK'));
...
begin
  ...
  Exec('taskkill', '/F /IM "PEAK.exe"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode);
